...
.shadow-\[0_-10px_20px_rgba\(99\2c 102\2c 241\2c 0\.2\)\] {
  --tw-shadow: 0 -10px 20px rgba(99,102,241,0.2);
...
.shadow-\[0_50px_120px_rgba\(0\2c 0\2c 0\2c 0\.15\)\] {
  --tw-shadow: 0 50px 120px rgba(0,0,0,0.15);
  --tw-shadow-colored: 0 50px 120px var(--tw-shadow-color);
  box-shadow: var(--tw-ring-offset-shadow, 0 0 #0000), var(--tw-ring-shadow, 0 0 #0000), var(--tw-shadow);
}
...
.hover\:shadow-\[0_20px_50px_rgba\(0\2c 0\2c 0\2c 0\.1\)\]:hover {
...
.group\/stat:hover .group-hover\/stat\:scale-110 {
  --tw-scale-x: 1.1;
  --tw-scale-y: 1.1;
  transform: translate(var(--tw-translate-x), var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y));
}
...
.group\/chart:hover .group-hover\/chart\:opacity-100 {
  opacity: 1;
}
